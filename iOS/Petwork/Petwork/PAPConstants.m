...
NSString *const kPAPUserDefaultsActivityFeedViewControllerLastRefreshKey    = @"com.petworkapp.Petwork.userDefaults.activityFeedViewController.lastRefresh";
NSString *const kPAPUserDefaultsCacheFacebookFriendsKey                     = @"com.petworkapp.Petwork.userDefaults.cache.facebookFriends";
...
NSString *const PAPAppDelegateApplicationDidReceiveRemoteNotification           = @"com.petworkapp.Petwork.appDelegate.applicationDidReceiveRemoteNotification";
NSString *const PAPUtilityUserFollowingChangedNotification                      = @"com.petworkapp.Petwork.utility.userFollowingChanged";
NSString *const PAPUtilityUserLikedUnlikedPhotoCallbackFinishedNotification     = @"com.petworkapp.Petwork.utility.userLikedUnlikedPhotoCallbackFinished";
NSString *const PAPUtilityDidFinishProcessingProfilePictureNotification         = @"com.petworkapp.Petwork.utility.didFinishProcessingProfilePictureNotification";
NSString *const PAPTabBarControllerDidFinishEditingPhotoNotification            = @"com.petworkapp.Petwork.tabBarController.didFinishEditingPhoto";
NSString *const PAPTabBarControllerDidFinishImageFileUploadNotification         = @"com.petworkapp.Petwork.tabBarController.didFinishImageFileUploadNotification";
NSString *const PAPPhotoDetailsViewControllerUserDeletedPhotoNotification       = @"com.petworkapp.Petwork.photoDetailsViewController.userDeletedPhoto";
NSString *const PAPPhotoDetailsViewControllerUserLikedUnlikedPhotoNotification  = @"com.petworkapp.Petwork.photoDetailsViewController.userLikedUnlikedPhotoInDetailsViewNotification";
NSString *const PAPPhotoDetailsViewControllerUserCommentedOnPhotoNotification   = @"com.petworkapp.Petwork.photoDetailsViewController.userCommentedOnPhotoInDetailsViewNotification";
